...
![Aurora with all the Underscores files](/admin/images/posts/building-a-theme-vs-a-decoupled-front-end/aurora-files-with-full-underscores.jpg)
Before: Aurora with the full set of files from Underscores

![Aurora homepage with default Underscores](/admin/images/posts/building-a-theme-vs-a-decoupled-front-end/aurora-home-with-full-underscores.jpg)
...
![Aurora with only the files needed for React dev](/admin/images/posts/building-a-theme-vs-a-decoupled-front-end/aurora-files-offical-starting-point.jpg)
...
![Aurora homepage after files were paired down](/admin/images/posts/building-a-theme-vs-a-decoupled-front-end/aurora-home-offical-start-point.jpg)
