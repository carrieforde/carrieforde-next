...
![JSON validator after first key-value regex check](/admin/images/posts/regex-revisited/regex_json-validator-first-key-value.jpg)
...
![JSON regex matching all but last key-value pair](/admin/images/posts/regex-revisited/regex_json-validator-all-but-last-key-value.jpg)
...
![Regex lookahead example](/admin/images/posts/regex-revisited/regex_lookaheads.jpg)
