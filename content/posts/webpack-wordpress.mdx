...
![An example of source maps in action.](/admin/images/posts/webpack-wordpress/source-map-example.jpg)
...
![The `bundle.js` file after the JS has been run through Babel.](/admin/images/posts/webpack-wordpress/transpiled-js.jpg)
...
![StyleLint errors in the terminal.](/admin/images/posts/webpack-wordpress/stylelint-output.jpg)
