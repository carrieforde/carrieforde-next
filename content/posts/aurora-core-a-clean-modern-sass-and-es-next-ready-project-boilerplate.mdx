...
![A screenshot of Sassdoc documentation for a button mixin within Aurora Core.](/admin/images/posts/aurora-core-a-clean-modern-sass-and-es-next-ready-project-boilerplate/button-sassdoc.jpg)
