...
![A successful Protractor test](/admin/images/posts/angular-testing-with-protractor-cucumber/a-successsful-protractor-test.jpg)
...
![Stubbed out step definition](/admin/images/posts/angular-testing-with-protractor-cucumber/stubbed-step-definition.jpg)
...
![Terminal output after Cucumber's Given step is implemented](/admin/images/posts/angular-testing-with-protractor-cucumber/cucumber-output-after-given-implemented.jpg)
...
![More passing Cucumber scenarios and steps](/admin/images/posts/angular-testing-with-protractor-cucumber/more-passing-scenarios-using-examples.jpg)
